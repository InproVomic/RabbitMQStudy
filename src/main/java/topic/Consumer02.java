...
public class Consumer02 {
    ...
    public static final String ROUTING_KEY_ONE = "*.*.rabbit";
    public static final String ROUTING_KEY_TWO = "lazy.#";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        // 绑定队列到交换机
        channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, ROUTING_KEY_ONE);
        channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, ROUTING_KEY_TWO);
        // 消费消息
